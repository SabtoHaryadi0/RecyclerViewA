package com.sabtoharyadi202102245.viewa;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm.setNama("Albania");
        nm.setDeskripsi("Bendera negara ini berwarna merah.");
        ...
        nm = new NegaraModel();
        nm.setNama("Hungary");
        nm.setDeskripsi("Belum ada deskripsi.");
        ...
        nm = new NegaraModel();
        nm.setNama("Belgium");
        nm.setDeskripsi("Negara ini terdapat di Eropa.");
